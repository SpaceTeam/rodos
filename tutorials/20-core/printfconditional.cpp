...
// you will see no prints because printfMask = 0;
// set to 0xffffffff for all prints
// or do not define (comment out) to get the default printfMask


uint32_t printfMask = 0; //Be aware: it is outside of namespace RODOS
...
public:
    void run() {
        ...
        PRINTF_CONDITIONAL(0xffffffff, "\n even with printfMaks=0, with id all in 1 will always be printed\n");
        printfMask = 1;

...
foreach(dir ${directories_to_include})
    ...
    target_include_directories(rodos_with_vector_table_offset PUBLIC $<INSTALL_INTERFACE:${rodos_INSTALL_INCLUDEDIR}/${dir}>)
endforeach()
...
install(
    TARGETS rodos_rodos rodos_with_vector_table_offset EXPORT rodosTargets
    ARCHIVE

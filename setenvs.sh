...
export CFLAGS=" -g -Wall -Wpedantic -Wextra -Wcast-qual -Wfloat-conversion -Wsign-conversion -Wdouble-promotion -Wnull-dereference -Wstrict-aliasing -Wno-long-long -Wno-cpp -fno-exceptions -O0 "

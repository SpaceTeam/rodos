...
#if defined (STM32F40_41xxx) || defined (STM32F411xE) || defined (STM32F427_437xx) || defined (STM32F429_439xx)
    #if (CPU_CLK == 100)
        #define PLL_N   200
        #define PLL_Q   4
        #define PLL_P   2
...
#if defined (STM32F401xx) || defined (STM32F40_41xxx) || defined (STM32F411xE) || defined (STM32F427_437xx) || defined (STM32F429_439xx)
    #if (CPU_CLK == 84)
        #define PLL_N   336
        #define PLL_Q   7
        #define PLL_P   4
...
#else
  /* If we don't want to offset, the vector table we don't need to set the register */
